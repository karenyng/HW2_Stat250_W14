...
/* R callable/entry point for invoking the threaded version of processing
 * several files concurrently. 
 * As this stands, this doesn't return the counts at all. It is only to 
 * determine the speed of using threads. This is just an illustration.*/
SEXP 
